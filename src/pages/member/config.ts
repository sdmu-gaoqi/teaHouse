...
import { memberStatusMap } from '@/constant/member'
  ...
  form: {
    ...
    fields: [
      ...
      },
      {
        ...
        key: 'time',
        format: 'timestamp',
        names: ['openAccBeginDate', 'openAccEndDate']
      },
      {
        type: 'range',
        label: '消费日期',
        ...
        key: 'latestSpendTime',
        format: 'timestamp',
        names: ['spendBeginDate', 'spendEndDate']
      }
    ]
  },
  tabs: [
    {
      ...
      columns: [
        ...
        },
        {
          title: '会员状态',
          dataIndex: 'status',
          options: Object.entries(memberStatusMap).map(([value, label]) => ({
            label,
            value
          }))
        },
