...
export default defineComponent({
  ...
  setup(props: BusinessModalProps) {
    const titleMap = {
      ...
      [BusinessModalType.会员退卡]: '会员退卡',
      [BusinessModalType.会员结算]: '订单结算',
      [BusinessModalType.编辑包厢]: '编辑包厢',
      [BusinessModalType.编辑菜品]: '编辑菜品',
    ...
    const elMap = {
      ...
      [BusinessModalType.编辑包厢]: roomEditForm,
      [BusinessModalType.编辑菜品]: projectForm,
    ...
    const widthMap = {
      ...
      [BusinessModalType.编辑包厢]: 900,
      [BusinessModalType.编辑菜品]: 900,
